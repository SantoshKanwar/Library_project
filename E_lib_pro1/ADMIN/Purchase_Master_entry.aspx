...
<%@ Page Language="C#" MasterPageFile="~/ADMIN/ADMIN.Master" AutoEventWireup="true" CodeBehind="Purchase_Master_entry.aspx.cs" Inherits="AURO.ADMIN.Purchase_Master_entry" Title="Purchase_Master Entry Page" %>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
    ...
    <center>  
        <table>  
            ...
            <tr>  
                <td>  
                    Purchas-Master Number :<asp:Label ID="Label6" runat="server" ForeColor="Red" 
                        Text="*"></asp:Label>
&nbsp;</td>  
                <td>  
