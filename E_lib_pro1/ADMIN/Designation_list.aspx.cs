...
{        
    public partial class Designation_list : System.Web.UI.Page        
    {        
        
        DesignationHandler A_Handler = null;        
        
        string Tbl_Name = "[Designation]";        
        string Entry_Page = "Designation_entry.aspx";        
        ...
        {        
            ...
            //if (IsPostBack == false)        
            //{        
            //    Grid1.DataSource = A_Handler.GetDesignationList();        
            //    Grid1.DataBind();   
