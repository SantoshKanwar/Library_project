<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/ADMIN.Master" AutoEventWireup="true" CodeBehind="View_Total_Book.aspx.cs" Inherits="E_lib_pro1.ADMIN.WebForm4" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT [Title], [Author], [Book_type], [NoOfBook], [IssueBooks], [AvlBooks], [College_Name], [Dep_name] FROM [ViewAcc_book_Ava]">
                        </asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
