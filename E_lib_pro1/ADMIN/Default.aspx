<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/ADMIN.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="E_lib_pro1.ADMIN.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<i style="color: #5b5b5b;">"If you think you can, you really can"</i>
		...
		<div class="shortcutHome">
		<a href="Department_list.aspx"><img src="auro-css/img/halaman.png"><br>Department</a>
		</div>
        <div class="shortcutHome">
		<a href="Designation_list.aspx"><img src="auro-css/img/photo.png"><br>Desigation</a>
		</div>
        <div class="shortcutHome">
		<a href="Composite_Dep_list.aspx"><img src="auro-css/img/halaman.png"><br>Clg Wise Depart</a>
		</div>
        <div class="shortcutHome">
		<a href="Composite1_Desig_list.aspx"><img src="auro-css/img/photo.png"><br>Clg Wise Design</a>
		</div>
		<div class="shortcutHome">
