...
{        
    public partial class Purchase_Detail_list : System.Web.UI.Page        
    {        
        
        Purchase_DetailHandler A_Handler = null;        
        
        string Tbl_Name = "[VPurchase_Detail]";        
        string Entry_Page = "Purchase_Detail_entry.aspx";        
        ...
        {        
            ...
            //if (IsPostBack == false)        
            //{        
            //    Grid1.DataSource = A_Handler.GetPurchase_DetailList();        
            //    Grid1.DataBind();        
        ...
        {
            Response.Redirect("~/Report/Rpt_Purchase_Detail.aspx");
        }
