...
{        
    public partial class Order_Master_list : System.Web.UI.Page        
    {        
        
        Order_MasterHandler A_Handler = null;        
        
        string Tbl_Name = "[VOrder_Master]";        
        string Entry_Page = "Order_Master_entry.aspx";        
        ...
        {        
            ...
            //Grid1.DataSource = A_Handler.GetOrder_MasterList(sql);        
            //Grid1.DataBind(); 
        ...
        {
            Response.Redirect("~/Report/Rpt_Order_Master.aspx");
        }        
