...
{        
    public partial class Composite_Dep_list : System.Web.UI.Page        
    {        
        
        Composite_DepHandler A_Handler = null;        
        
        string Tbl_Name = "[VComposite_Dep]";        
        string Entry_Page = "Composite_Dep_entry.aspx";        
        ...
        {        
            ...
            //if (IsPostBack == false)        
            //{        
            //    Grid1.DataSource = A_Handler.GetComposite_DepList();        
            ////    Grid1.DataBind();        
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
           ...
           A_Handler = new Composite_DepHandler();        
            ...
            //Grid1.DataSource = A_Handler.GetComposite_DepList(sql);        
            //Grid1.DataBind();        
