...
<%@ Page Language="C#" MasterPageFile="~/ADMIN/ADMIN.Master" AutoEventWireup="true" CodeBehind="College_entry.aspx.cs" Inherits="AURO.ADMIN.College_entry" Title="College Entry Page" %>  
            ...
            <tr>  
                ...
                <td>  
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
                        ControlToValidate="DdlStatus" InitialValue="-" Font-Bold="true" ErrorMessage="Please Select Status" 
                        ForeColor="Red"></asp:RequiredFieldValidator>
                </td>  
            </tr>  
            <tr>  
