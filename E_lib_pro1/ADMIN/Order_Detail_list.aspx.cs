...
{        
    public partial class Order_Detail_list : System.Web.UI.Page        
    {        
        
        Order_DetailHandler A_Handler = null;        
        
        string Tbl_Name = "[VOrder_Detail]";        
        string Entry_Page = "Order_Detail_entry.aspx";        
        ...
        {        
            ...
            //if (IsPostBack == false)        
            //{        
            //    Grid1.DataSource = A_Handler.GetOrder_DetailList();        
            //    Grid1.DataBind();        
        ...
        {        
            ...
            //Grid1.DataSource = A_Handler.GetOrder_DetailList(sql);        
            //Grid1.DataBind();   
        ...
        {
            Response.Redirect("~/Report/Rpt_Order_Detail.aspx");
        }        
