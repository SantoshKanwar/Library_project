...
<%@ Page Language="C#" MasterPageFile="~/ADMIN/ADMIN.Master" AutoEventWireup="true" CodeBehind="Member_entry.aspx.cs" Inherits="AURO.ADMIN.Member_entry" Title="Member Entry Page" %>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
    ...
    <center style="height: 1263px; width: 736px">  
        <table>  
            <tr>  
            ...
            <tr>  
                ...
                <td>  
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
                        ControlToValidate="txtDob" ErrorMessage="Enter The Date" 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
                </td>  
            </tr>  
            <tr>  
            ...
            <tr>  
                ...
                <td>  
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                        ControlToValidate="txtMember_code" ErrorMessage="Enter The Member Code">*</asp:RequiredFieldValidator>
                </td>  
            </tr>  
            <tr>  
                <td>  
