...
{        
    public partial class Accession_list : System.Web.UI.Page        
    {        
        
        AccessionHandler A_Handler = null;        
        
        string Tbl_Name = "[VAccession]";        
        string Entry_Page = "Accession_entry.aspx";        
        ...
        {
            Response.Redirect("~/Report/Rpt_Accession.aspx");
        }        
