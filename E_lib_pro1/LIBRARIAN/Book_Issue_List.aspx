<%@ Page Title="" Language="C#" MasterPageFile="~/LIBRARIAN/Librian.Master" AutoEventWireup="true" CodeBehind="Book_Issue_List.aspx.cs" Inherits="E_lib_pro1.LIBRARIAN.WebForm28" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="Grid1" runat="server" AutoGenerateColumns="False" 
                            ...
                            AllowSorting="True" onselectedindexchanged="Grid1_SelectedIndexChanged">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                            <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("Bir_id","~/LIBRARIAN/Book_Issue_entry.aspx?action=del&amp;id={0}") %>' Text="Delete"></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                  <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("Bir_id","~/LIBRARIAN/Book_Issue_entry.aspx?action=upd&amp;id={0}") %>' Text="Update"></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                             
                                <asp:BoundField DataField="Bir_id" HeaderText="Bir_id" 
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT * FROM [VBook_Issue]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    <td>
