<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Member.aspx.cs" Inherits="E_lib_pro1.WebForm3" %>
...
&nbsp;</td>  
            ...
            <tr>  
                ...
                <td>  
                    &nbsp;  
                    <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtPassword" 
            ...
            <tr>  
                ...
                <td>  
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
                        ControlToValidate="txtDob" ErrorMessage="Enter DATE" ForeColor="Red">*</asp:RequiredFieldValidator>
                </td>  
            </tr>  
            <tr>  
                <td>  
            ...
            <tr>  
                ...
                <td>  
                    <asp:DropDownList ID="ddlDep_id" runat="server" Height="25px" Width="150px" 
                        DataSourceID="SqlDataSource2" DataTextField="Dep_name" DataValueField="Dep_id">  
                    </asp:DropDownList>  
