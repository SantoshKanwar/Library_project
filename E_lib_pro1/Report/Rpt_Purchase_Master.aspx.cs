...
{
    public partial class Rpt_Purchase_Master : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            reportPath = Server.MapPath("~/Report/Purchase_Master.rpt");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "select * from VPurchase_Master where  " + fld + " like '" + txt + "%'  ";
            }
            else
            {
                DateTime sdate = DateTime.Parse(TextBox2.Text);
                DateTime edate = DateTime.Parse(TextBox3.Text);
                sql = "select *from VPurchase_Master where Pur_date >='" + sdate + "' and Pur_date <='" + edate + "' ";
            }
