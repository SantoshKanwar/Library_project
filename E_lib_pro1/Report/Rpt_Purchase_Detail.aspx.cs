...
{
    public partial class Rpt_Purchase_Detail : System.Web.UI.Page
    {
        string Tbl_Name = "[VPurchase_Detail]";
        string sql = "";
        string reportPath;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            reportPath = Server.MapPath("~/Report/Purchase_Detail.rpt");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "select * from VPurchase_Detail where  " + fld + " like '" + txt + "%'  ";
            }
            else
            {
                DateTime sdate = DateTime.Parse(TextBox2.Text);
                DateTime edate = DateTime.Parse(TextBox3.Text);
                sql = "select *from VPurchase_Detail where Pur_date >='" + sdate + "' and Pur_date <='" + edate + "' ";
            }
