...
{
    public partial class Rpt_Order_Detail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            reportPath = Server.MapPath("~/Report/Order_Detail.rpt");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "select * from VOrder_Detail where  " + fld + " like '" + txt + "%'  ";
            }
            else
            {
                DateTime sdate = DateTime.Parse(TextBox2.Text);
                DateTime edate = DateTime.Parse(TextBox3.Text);
                sql = "select *from VOrder_Detail where Ord_date >='" + sdate + "' and Ord_date <='" + edate + "' ";
            }
