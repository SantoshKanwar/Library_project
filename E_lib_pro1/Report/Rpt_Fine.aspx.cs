...
{ 
    ...
    public partial class Rpt_Fine : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            reportPath = Server.MapPath("~/Report/Fine.rpt");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "select * from VFine where  " + fld + " like '" + txt + "%'  ";
            }
            else
            {
                DateTime sdate = DateTime.Parse(TextBox2.Text);
                DateTime edate = DateTime.Parse(TextBox3.Text);
                sql = "select *from VFine where Fine_date >='" + sdate + "' and Fine_date <='" + edate + "' ";
            }
            dt = my.GetTable(sql);
            report1.SetDataSource(dt);
            CrystalReportViewer1.ReportSource = report1;
