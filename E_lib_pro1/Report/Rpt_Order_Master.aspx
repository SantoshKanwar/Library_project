<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rpt_Order_Master.aspx.cs" Inherits="E_lib_pro1.Report.Rpt_Order_Master" %>
...
<body>
    ...
    <div>
        ...
        <td><span class="style1"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            ...
            <span class="style1">DATE :</span> <strong>
            <asp:TextBox ID="TextBox2" runat="server" CssClass="style1"></asp:TextBox>
            <span class="style1">&nbsp; <span class="style2">TO :</span> </span>
