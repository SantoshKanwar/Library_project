<%@ Page Title="" Language="C#" MasterPageFile="~/USER/user.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="E_lib_pro1.USER.WebForm4" %>
            ...
            <tr>  
                ...
                <td>  
                    <asp:DropDownList ID="ddlReg_id" runat="server" Height="25px" Width="150px" 
                        ...
                        DataValueField="Reg_id" Visible="False">  
                    </asp:DropDownList>  
            ...
            <tr>  
                ...
                <td>  
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        SelectCommand="SELECT [Dep_name], [Dep_id] FROM [Department]">
                    </asp:SqlDataSource>
                </td>  
                <td>  
                    &nbsp;  
